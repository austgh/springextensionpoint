package com.example.springextensionpoint.applicationListener;
 ...
 */
@Component
public class TestMyApplicationListener implements ApplicationListener {
    @Override
